...
TEST_CASE("test-1107a_pdf")
{
    ...
    REQUIRE(bib_optional->at("[47]") ==
            "“Site Technical Audit Report (STAR) UTAC Thai Limited, UTL1 / UTL.3”, Version 1, 2020-10-12, TÜV Informationstechnik GmbH");
}
...
TEST_CASE("Certification_Report_NSCIB-CC-200689-CR.txt")
{
    ...
    REQUIRE(bib_optional->at("[TR_03110]") ==
            "Technical Guideline Advanced Security Mechanisms for Machine Readable Travel Documents – Part 1 – eMRTDs with BAC/PACEv2 and "
